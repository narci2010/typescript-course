...
export default function basetypes() {
  ...
  log(decLiteral, hexLiteral, binaryLiteral, octalLiteral)
...
I'll be ${age + 1} years old next month.`
  ...
  log(name, name2, age, sentence, sentence2)
  ...
  listAny[1] = 100
  log(notSure, prettySure, listAny)
  ...
  log(create({ prop: 0 })) // OK
  log(create(null)) // OK
  //   create(42) // Error
  //   create('string') // Error
  //   create(false) // Error
  //   create(undefined) // runtime error
